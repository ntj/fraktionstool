...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vorhaben.beobachten'
        db.add_column(u'fraktionstool_vorhaben', 'beobachten',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Vorhaben.geschlossen'
        db.add_column(u'fraktionstool_vorhaben', 'geschlossen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vorhaben.beobachten'
        db.delete_column(u'fraktionstool_vorhaben', 'beobachten')

        # Deleting field 'Vorhaben.geschlossen'
        db.delete_column(u'fraktionstool_vorhaben', 'geschlossen')
