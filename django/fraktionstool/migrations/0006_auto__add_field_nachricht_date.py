...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nachricht.date'
        db.add_column(u'fraktionstool_nachricht', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 28, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nachricht.date'
        db.delete_column(u'fraktionstool_nachricht', 'date')
