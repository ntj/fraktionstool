...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hilfe.heading'
        db.add_column(u'fraktionstool_hilfe', 'heading',
                      self.gf('django.db.models.fields.CharField')(default='Abschnitt', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hilfe.heading'
        db.delete_column(u'fraktionstool_hilfe', 'heading')
