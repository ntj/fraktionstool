...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vorhaben.abstimmung'
        db.add_column(u'fraktionstool_vorhaben', 'abstimmung',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vorhaben.abstimmung'
        db.delete_column(u'fraktionstool_vorhaben', 'abstimmung')
    ...
    models = {
        ...
        u'fraktionstool.vorhaben': {
            ...
            'abstimmung': ('django.db.models.fields.TextField', [], {}),
