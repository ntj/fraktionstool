...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vorhaben.date'
        db.add_column(u'fraktionstool_vorhaben', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 28, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vorhaben.date'
        db.delete_column(u'fraktionstool_vorhaben', 'date')
