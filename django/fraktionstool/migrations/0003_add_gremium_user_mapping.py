...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GremiumUser'
        db.create_table(u'fraktionstool_gremiumuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gremium', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fraktionstool.Gremium'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'fraktionstool', ['GremiumUser'])


    def backwards(self, orm):
        # Deleting model 'GremiumUser'
        db.delete_table(u'fraktionstool_gremiumuser')
